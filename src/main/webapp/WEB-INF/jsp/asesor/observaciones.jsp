                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="dashboard_graph">
                          	...
                          	<div class="row x_title">
                                <div class="col-md-12">
                                  <h3>OBSERVACIONES &nbsp;</h3><h3 id="entregable"><small>Entregable 1</small></h3>
                                </div>
                         	</div>
							<div class="dashboard_graph">
                            	<h4>Comentarios del asesor: </h4><br>
                                <form>
                                	<label for="message">Comentarios:</label>
                                    <textarea id="message" class="form-control" name="message"></textarea>
                                    <br>
                                    <div class="col-md-6 col-sm-6 col-xs-6">
                                    <label for="uploadbtn">Subir archivo de feedback:</label><br>
                                    <span class="btn btn-primary" id="uploadbtn" name="uploadbtn"><i class="fa fa-cloud-upload"></i> Subir</span><br>
                                    </div>
