                                    ...
                                    <div class="x_content">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            ...
                                            <div class="profile_title">
                                                ...
                                                <div class="col-md-3">
                                                    <h2>Busqueda:</h2>
                                                    <c:if test="${busquedaFiltro.ciclo ==null}">
                                                        <form:form modelAttribute="busquedaFiltro" action="profile_buscar" role="form" class="form-horizontal" method="POST">
                                                            ...
                                                            <c:if test="${busquedaFiltro.ciclo !=null}">
                                                                <form:form modelAttribute="nuevoFiltro" action="l_entrega" role="form" class="form-horizontal" method="POST">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-12">
                                                                            <form:select path="ciclo" class="form-control">
                                                                                ...
                                                                                <c:forEach items="${ListaCiclos}" var="p"> <!-- Consultar el generar el combo a partir del curso dado -->
                                                                                    <c:if test="${busquedaFiltro.ciclo.equals(p.ciclo)}">
                                                                                        <option  value="${p.ciclo}" ${p.ciclo==nuevoFiltro.ciclo?"selected":""}>${p.ciclo} </option>
                                                                                    </c:if>
                                                                                ...
                                                                                <div class="col-sm-12">
                                                                                    <form:select path="idCurso" class="form-control">
                                                                                        ...
                                                                                        <c:forEach items="${ListaCursos}" var="p">
                                                                                            <option  value="${p.idCurso}" ${p.idCurso==nuevoFiltro.idCurso?"selected":""}>${p.nombre} </option>
                                                                                        </c:forEach>
                                                                                    </form:select>
                                                                                </div>
                                                                            </div>  
